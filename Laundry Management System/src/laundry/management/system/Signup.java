...
public class Signup extends JFrame implements ActionListener{
    ...
    JButton create, back;
    JTextField tfempid, tfname, tfemail, tfpassword, tfanswer;
    Choice security;
    ...
    Signup(){
        ...
        lblempid.setBounds(50,20,125,25);
        p1.add(lblempid);
        
        tfempid=new JTextField();
        tfempid.setBounds(190,20,180,25);
        ...
        lblemail.setBounds(50,100,125,25);
        p1.add(lblemail);
        
        tfemail=new JTextField();
        tfemail.setBounds(190,100,180,25);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==create){
            ...
            String query="insert into signup values('"+empid+"', '"+name+"', '"+email+"', '"+password+"', '"+question+"', '"+answer+"' )";
